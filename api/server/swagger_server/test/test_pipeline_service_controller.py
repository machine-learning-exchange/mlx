...
class TestPipelineServiceController(BaseTestCase):
    ...
    def test_delete_pipeline(self):
        ...
        response = self.client.open(
            "/apis/v1alpha1/pipelines/{id}".format(id="id_example"), method="DELETE"
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
    ...
    def test_get_pipeline(self):
        ...
        response = self.client.open(
            "/apis/v1alpha1/pipelines/{id}".format(id="id_example"), method="GET"
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
    ...
    def test_list_pipelines(self):
        ...
        response = self.client.open(
            "/apis/v1alpha1/pipelines", method="GET", query_string=query_string
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
    ...
    def test_upload_pipeline(self):
        ...
        data = dict(
            uploadfile=(BytesIO(b"some file data"), "file.txt"),
