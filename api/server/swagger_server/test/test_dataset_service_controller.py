...
class TestDatasetServiceController(BaseTestCase):
    ...
    def test_delete_dataset(self):
        ...
        response = self.client.open(
            "/apis/v1alpha1/datasets/{id}".format(id="id_example"), method="DELETE"
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
    ...
    def test_get_dataset(self):
        ...
        response = self.client.open(
            "/apis/v1alpha1/datasets/{id}".format(id="id_example"), method="GET"
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
    ...
    def test_list_datasets(self):
        ...
        response = self.client.open(
            "/apis/v1alpha1/datasets", method="GET", query_string=query_string
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
