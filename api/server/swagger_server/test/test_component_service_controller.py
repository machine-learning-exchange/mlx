...
class TestComponentServiceController(BaseTestCase):
    ...
    def test_delete_component(self):
        ...
        response = self.client.open(
            "/apis/v1alpha1/components/{id}".format(id="id_example"), method="DELETE"
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
    ...
    def test_get_component(self):
        ...
        response = self.client.open(
            "/apis/v1alpha1/components/{id}".format(id="id_example"), method="GET"
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
    ...
    def test_list_components(self):
        ...
        response = self.client.open(
            "/apis/v1alpha1/components", method="GET", query_string=query_string
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
