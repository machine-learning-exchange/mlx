...
class TestNotebookServiceController(BaseTestCase):
    ...
    def test_delete_notebook(self):
        ...
        response = self.client.open(
            "/apis/v1alpha1/notebooks/{id}".format(id="id_example"), method="DELETE"
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
    ...
    def test_get_notebook(self):
        ...
        response = self.client.open(
            "/apis/v1alpha1/notebooks/{id}".format(id="id_example"), method="GET"
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
    ...
    def test_list_notebooks(self):
        ...
        response = self.client.open(
            "/apis/v1alpha1/notebooks", method="GET", query_string=query_string
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
