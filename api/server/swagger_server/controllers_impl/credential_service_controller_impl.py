...
from swagger_server.gateways.kubernetes_service import (
    create_secret,
    get_secret,
    delete_secret,
    list_secrets,
...
def create_credential(body):  # noqa: E501
    ...
    api_credential.id = (
        api_credential.id or f"{secret_name_prefix}-{generate_id(length=16)}".lower()
    )
    ...
    secret = create_secret(
        ...
        {
            key: value
            for key, value in api_credential.to_dict().items()
...
def list_credentials(
    ...
    api_credentials: [ApiCredential] = load_data(
        ApiCredential,
    ...
    comp_list = ApiListCredentialsResponse(
