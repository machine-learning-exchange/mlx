...
def get_inferenceservices(id, namespace=None):  # noqa: E501
    ...
    try:
        single_service = get_all_services(
            id,
            namespace=namespace,
...
def list_inferenceservices(
    ...
    try:
        ...
        all_mm_services = get_all_services(
            namespace=namespace,
            group="serving.kserve.io",
            version="v1alpha1",
            plural="predictors",
        )
        all_k_services = get_all_services(
            namespace=namespace,
            group="serving.kserve.io",
            version="v1beta1",
            plural="inferenceservices",
...
def upload_service(uploadfile, name=None, namespace=None):  # noqa: E501
    ...
    log = logging.getLogger("inf_serv")
    try:
        uploaded_service = from_client_upload_service(
            upload_file=uploadfile, namespace=namespace
        )
