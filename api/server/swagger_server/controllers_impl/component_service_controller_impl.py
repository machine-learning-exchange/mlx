...
from swagger_server.gateways.kubeflow_pipeline_service import (
    generate_component_run_script,
    run_component_in_experiment,
    _host as KFP_HOST,
)
...
from swagger_server.models.api_list_components_response import (  # noqa: F401
...
def create_component(body):  # noqa: E501
    ...
    if connexion.request.is_json:
        body = ApiComponent.from_dict(connexion.request.get_json())
...
def list_components(
    ...
    api_components: [ApiComponent] = load_data(
        ApiComponent,
    ...
    comp_list = ApiListComponentsResponse(
...
def run_component(id, parameters, run_name=None):  # noqa: E501
    ...
    try:
        run_id = run_component_in_experiment(
            api_component, api_template.url, parameter_dict, run_name
        )
...
def upload_component(
    uploadfile: FileStorage, name=None, existing_id=None
):  # noqa: E501
    """upload_component
...
def upload_component_file(id, uploadfile):  # noqa: E501
    ...
    if file_ext in ["tgz", "gz", "yaml", "yml"]:
        ...
        return (
            f"The API method 'upload_component_file' is not implemented for file type '{file_ext}'.",
            501,
        )
