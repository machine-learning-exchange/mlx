...
class ApiComponent(ApiAsset):
    ...
    def filter_categories(self) -> Dict[str, str]:
        """Gets the filter_categories of this ApiComponent.


        :return: The filter_categories of this ApiComponent.
        :rtype: Dict[str, str]
        """
    ...
    def filter_categories(self, filter_categories: Dict[str, str]):
        ...
        :param filter_categories: The filter_categories of this ApiComponent.
        :type filter_categories: Dict[str, str]
        """
