...
def post_service(
    inferenceservice=None, namespace=None, group=None, version=None, plural=None
):
...
def from_client_upload_service(
    upload_file=None, namespace=None, group=None, version=None, plural=None
):
