                ...
                <div className="submit-button-wrapper">
                  <TextField
                    ...
                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                        setRun({ ...run, [relatedAsset]: {...run[relatedAsset], runname: e.currentTarget.value} })}
                  />
                  <TextField
                    key="dataset-pvc"
                    label='Dataset PVC'
                    ...
                    InputLabelProps={{ shrink: true, }}
                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                      setRun({ ...run, [relatedAsset]: {...run[relatedAsset], dataset_pvc: e.currentTarget.value} })}
                  />
                  <TextField
                    key="mount-path"
                    label='Mount Path'
                    ...
                    InputLabelProps={{ shrink: true, }}
                    onChange={(e: ChangeEvent<HTMLInputElement>) =>
                      setRun({ ...run, [relatedAsset]: {...run[relatedAsset], mount_path: e.currentTarget.value} })}
                  />
                  <Button 
